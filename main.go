...
func NearmapTilesV3IMGURLSatelliteFallback(x, y, z int, tilestype, apikey string) string {
	return fmt.Sprintf("https://api.nearmap.com/tiles/v3/%s/%d/%d/%d.img?tertiary=satellite&apikey=%s", tilestype, z, x, y, apikey)
}
